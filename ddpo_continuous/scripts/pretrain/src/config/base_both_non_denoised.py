...
def get_config():
    ...
    config.design = {"first":"original","second":"original","skip_func_in":"cos","skip_func_out":"1-cos"}
    ...
    config.run_name = "image_reward_training_fixrate=0.7_double-undenoised_warmup=0.05"
